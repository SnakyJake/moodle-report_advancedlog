 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class report_advancedlog_table_log extends table_sql {
    ...
    public function __construct($uniqueid, $filterparams = null) {
        ...
        $this->set_attribute('class', 'reportadvancedlog generaltable generalbox table-sm');
    ...
    public function col_fullnameuser($event) {
        ...
        if (!empty($logextra['realuserid'])) {
            ...
            $username = get_string('eventloggedas', 'report_advancedlog', $a);
