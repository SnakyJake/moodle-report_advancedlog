...
/**
 * The report_advancedlog report viewed event.
 *
...
/**
 * The report_advancedlog report viewed event class.
 *
...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'report_advancedlog');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, "course", "report log", "report/advancedlog/index.php?id=$this->courseid", $this->courseid);
    }
    ...
    public function get_url() {
        return new \moodle_url('/report/advancedlog/index.php', array('id' => $this->courseid));
    }
