 ...
 * Lang strings.
 *
 * Language strings to be used by report/advancedlogs
 *
...
$string['advancedlog:view'] = 'View course logs';
$string['advancedlog:viewtoday'] = 'View today\'s logs';
$string['page'] = 'Page {$a}';
$string['logsformat'] = 'Logs format';
$string['nocapability'] = 'Cannot access user log report';
...
$string['pluginname'] = 'Advanced Logs';
